    ...
    <section className="section solutions" id="giai-phap">
      <div className="container">
        <div className="section-heading split-heading reveal">
          <div>
            <p className="kicker">Mẫu giải pháp phổ biến</p>
            <h2>Ba hướng đi phổ biến — bắt đầu từ điểm phù hợp nhất với bạn.</h2>
          </div>
          <p>
            Đây là các mẫu giải pháp minh họa cho doanh nghiệp nhỏ — điều chỉnh
            theo mô hình và quy mô thực tế. Bạn không cần làm hết, chỉ cần bắt đầu
            từ một điểm phù hợp.
          </p>
        </div>
        ...
        <div className="featured-solution reveal">
          <div className="featured-copy">
            ...
            <h3>Quản lý vận hành một chỗ</h3>
            <p>
            ...
            <ul className="check-list">
              ...
              <li><span>✓</span> Số liệu cập nhật từng phút</li>
            </ul>
        ...
        <div className="solution-cards">
          <article className="solution-card reveal">
            ...
            <div className="solution-card-copy">
              ...
              <p>Tự động gom đơn từ Shopee, TikTok, website và cửa hàng vào một chỗ — đồng bộ kho, giá, khách hàng, không còn nhập tay từng đơn.</p>
          ...
          <article className="solution-card reveal" data-delay="1">
            ...
            <div className="solution-card-copy">
              ...
              <p>Tổng hợp doanh thu, chi phí, tồn kho, khách hàng thành báo cáo tự động, phát hiện bất thường và gợi ý hành động tiếp theo.</p>
              <div className="tag-list">
        ...
        <p className="integrity-note reveal">
          ...
          pháp&rdquo; — đây là ví dụ minh họa, không phải dự án khách hàng thực tế. Khi
          có dự án được phép công bố, chúng tôi sẽ thay bằng tên ngành, phạm vi và
          kết quả thật.
        </p>
      </div>
    </section>
